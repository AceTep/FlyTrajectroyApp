        ...
        with open(path, "r") as f:
            ...
            for row in reader:
                try:
                    ...
                    continue
        return interactions  # No sorting
...
class CSVFilterApp(QWidget):
    ...
    def generate_video(self):
        ...
        self.video_thread = VideoProcessingThread(self.all_flies_df, video_path, edgelist_path)
...
if __name__ == "__main__":
    os.environ["QT_QPA_PLATFORM_PLUGIN_PATH"] = "/path/to/your/qt/plugins/platforms"  # Update if needed
